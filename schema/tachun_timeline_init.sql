...
CREATE INDEX ON fractal.tachun_schema.users(email, username);
...
CREATE INDEX ON fractal.tachun_schema.relationships (follower_id);
CREATE INDEX ON fractal.tachun_schema.relationships (followed_id);
